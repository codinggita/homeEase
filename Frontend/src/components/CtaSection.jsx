    ...
    <section className="py-24 px-8">
      <div className="max-w-5xl mx-auto bg-primary-fixed rounded-xl p-12 md:p-24 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8">
          ...
          <Link to="/signup" className="bg-primary text-on-primary px-12 py-6 rounded-full font-black text-2xl shadow-2xl hover:bg-primary-dim transition-all inline-block">Book Your First Helper</Link>
        </div>
      </div>
    </section>
  );
